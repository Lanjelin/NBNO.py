...
parser = argparse.ArgumentParser(description='NB.no nedlaster')
parser.add_argument('--id', metavar='', help='IDen på boken som skal lastes ned', default=False)
parser.add_argument('--start', metavar='', help='Sidetall å starte på', default=False)
parser.add_argument('--stop', metavar='', help='Sidetall å stoppe på', default=False)
parser.add_argument('--level', metavar='', help='Level', default=False)
parser.add_argument('--maxlevel', metavar='', help='MaxLevel', default=False)
args = parser.parse_args()


#x = theURL('2012112808068')
#x = theURL('2008121500142') #Tolkien, brev fra Julenissen 20 bilder per side ved 5/5 level
